...
- **[GitHub Copilot SDK](https://github.com/ArlindNocaj/ag-ui/tree/feature/add-copilot-sdk-support/integrations/copilot-sdk)** - Community Python and TypeScript adapters with session-owned frontend-tool continuation (fork-only review)
